  ...
  /*************************************************************************
    ...
    ***************************************************************************/
    ...
    public static void main(String[] args) { 
        ...
        String [] sample = "S E A R C H E X A M P L E".split(" ");
        for (int i = 0; i < sample.length; i++) {
            String key = sample[i];
            st.put(key, i);
            StdOut.println("key " + key + " " + i );
        }
...
//        StdOut.println("Get Hit:" +st.get("R"));
//        StdOut.println("Get Miss:" +st.get("Z"));
//        StdOut.println(st.min());
        
        StdOut.println();
        StdOut.println(st.floor("K"));
    }
}
